...
class CartProvider extends ChangeNotifier {
  List <Product> allProducts = [
    ...
    Product(
      ...
      "Mens Lether Jacket",
      55.99,
      "This versatile jacket is perfect for transitioning between seasons. Designed for warmth and comfort, it features a sturdy Lether exterior and a soft, insulated lining. Ideal for spring, autumn, and winter, it keeps you cozy during outdoor activities such as hiking, camping, or casual strolls. Whether you're heading to work or spending time with family, this jacket combines style with functionality, offering a practical solution for any occasion. It also makes for an excellent gift for loved ones.",
      "men's clothing",
      [
        "images/3.1.jpg",
        "images/3.2.jpg",
    ...
    Product(
      ...
      "John Hardy",
      "30 day return",
      "Material: 925 Sterling Silver, 18K Gold\nLength: Adjustable 7-8 inches",
      Rating(4.6, 400),
    ),
    Product(
      6,
      ...
      "Hafeez Center",
      "30 day return",
      "Material: 14K Solid Gold, Diamonds\nAvailable Sizes: 6, 7, 8",
      Rating(3.9, 70),
    ),
    Product(
      7,
    ...
    Product(
      ...
      "Samsung",
      "90 day return",
      "Capacity: 2TB\nInterface: USB 3.0, USB 2.0\nCompatibility: Windows 10, 8.1, 7, Reformatting required for Mac\nColor: Black",
      Rating(3.3, 203),
    ),
    Product(
      10,
      ...
      "SanDisk",
      "30 day return",
      "Capacity: 1TB, Interface: SATA III 6 Gb/s\nRead Speed: 535MB/s\nWrite Speed: 450MB/s\nColor: Black",
      Rating(2.9, 470),
    ),
    Product(
      11,
    ...
    Product(
      ...
      "Acer",
      "30 day return",
      "Screen Size: 21.5 inches\nResolution: 1920 x 1080 Full HD\nPanel Type: IPS, Refresh 75Hz\nColor: Black, Response Time: 4ms",
      Rating(2.9, 250),
    ),
    Product(
      14,
      ...
      "Samsung",
      "30 day return",
      "Size: 49 inches\nColor: Black\nMaterial: Plastic and Metal\nDimensions: 47.1 x 18.7 x 10.3 inches",
      Rating(2.2, 140),
    ),
    Product(
      15,
    ...
    Product(
      ...
      "Lock and Love",
      "Not returnable",
      "Material: Polyurethane (shell), Polyester (lining), Polyester and Cotton (sweater)\nColor: Black, Size: M, L, XL\nDimensions: 24 x 20 x 6 inches",
      Rating(2.9, 340),
    ),
    Product(
      17,
      ...
      "Windbreaker",
      "30 day return",
      "Material: Denim, Cotton Lining\nColor: Blue, Size: S, M, L, XL\nDimensions: 22 x 18 x 4 inches",
      Rating(3.8, 679),
    ),
    Product(
      18,
    ...
    Product(
      ...
      "Opna",
      "30 day return",
      "Material: 100% Polyester\nColor: Variety of colors, Size: S, M, L, XL\nDimensions: 12 x 8 x 0.5 inches",
      Rating(4.5, 146),
    ),
    Product(
      20,
